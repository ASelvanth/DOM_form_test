...
h1Tag.innerHTML = "DOM Manipulation Task";
container.append(h1Tag);

// // p Tag
let pTag = document.createElement("p");
pTag.setAttribute("id","description");
pTag.innerHTML = "User Form";
...
// Choice of food - parotta
let parotta = document.createElement("input");
parotta.setAttribute("type", "checkbox");
parotta.setAttribute("id", "parotta");
parotta.setAttribute("name", "food");
parotta.innerHTML = "idli";
food.append(parotta);
food.append(" parotta ");


// Choice of food - noodles
let noodles = document.createElement("input");
noodles.setAttribute("type", "checkbox");
noodles.setAttribute("id", "noodles");
noodles.setAttribute("name", "food");
noodles.innerHTML = "noodles";
food.append(noodles);
food.append(" noodles ");
...
tableHead.classList.add("bg-important")
...
function validate(event) {
    ...
    str = ""
    Food_List_1 = document.getElementById("Briyani").value;
    Food_List_2 = document.getElementById("parotta").value;
    Food_List_3 = document.getElementById("noodles").value;
    Food_List_4 = document.getElementById("chapati").value;
